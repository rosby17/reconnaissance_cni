...
car_image = imread("/home/rosby17/Documents/images/cni.jpg", as_gray=True)
...
#
###############################################################################
### SELECTION DE LA REGION DE LA CNI CONTENANT LES INFORMATION PERSONNELLES ### 
###############################################################################
...
Good_boy =car_image = imread("/home/rosby17/Documents/images/cni.jpg", as_gray=True)
plt.imshow(Good_boy)


####################################################################
###   SELECTION DE LA REGION DE LA CNI CONTENANT DES CARACTERES  ### 
####################################################################
...
character_dimensions = (0.03*license_plate.shape[0], 0.90*license_plate.shape[0], 0.004*license_plate.shape[1], 0.2*license_plate.shape[1])
...
for t in range (len(a)):
    a[t]=a[t]*255
    cv2.imwrite('cni_character.png',a[t])
    im=cv2.imread('cni_character.png')
...
class MyFirstGUI:
    def __init__(self, master):
        ...
        self.label = Label(master, text="Veuillez copier dans le dossier '/home/rosby17/Documents/images/recon_plaque' l'image de votre cni, sous le nom 'cni.jpg'").grid(row=0,column=1)
